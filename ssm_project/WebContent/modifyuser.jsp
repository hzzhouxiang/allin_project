...
<body>
	...
	<form action="javascript:;" method="post" id="user-form">
		...
		<input  maxlength="20" placeholder="密码" name="password" value= <c:out value="${usermsg.password}"></c:out>> <br> 
		<br> <input maxlength="1" placeholder="性别" name="gender">
		<input maxlength="11"  placeholder="联系电话" name="userphone" disabled="true" value= <c:out value="${usermsg.userphone}"></c:out> ><br> 
