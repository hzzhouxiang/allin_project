...
<%User user = new User();
user=(User)session.getAttribute("usermsg");%>
</script>
</head>
<body>
	<div >
	<form action="javascript:;" method="post" id="user-form">
		...
		<br> <input maxlength="11"  placeholder="联系电话" name="userphone"  value= <c:out value="${usermsg.userphone}"></c:out> >
		
		<br> 
		<input  maxlength="20" placeholder="密码" name="password" value= <c:out value="${usermsg.password}"></c:out>>
